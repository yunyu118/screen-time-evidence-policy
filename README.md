...
**13 policies · 10 jurisdictions · 1 with a prespecified evaluation · 6 never evaluated · 0 of 12 evaluations reporting suicide or self-harm**

---

## What this is

Governments in 10 jurisdictions have restricted children's access to social media, smartphones, or online games. Professional bodies have issued detailed usage guidance. This repository asks a narrow question about all of it: how much rests on evidence that the *intervention works*, as distinct from evidence that the *exposure is associated with harm*?
...
| | |
|---|---|
| Policies inventoried | 13 across 10 jurisdictions |
| Enacted with a prespecified evaluation | **1** |
| Never evaluated at all | **6** |
| Resting on correlational evidence alone | **11 of 13** |
| Published evaluations identified | 12 |
| ...reporting any mental health outcome | 5 |
| ...reporting suicide or self-harm | **0** |
